        ...
        return {
            ...
            controller: ['$attrs', '$timeout', '$scope', function ($attrs, $timeout, $scope) {
                ...
                $timeout(function () {
                    ...
                    controller.selectedItemsLabel = valueOrDefault(controller.selectedItemsLabel, $interpolate("เลือกรายการที่ต้องการ{{maxSelectedItems ? ' (มากสุด ' + maxSelectedItems + ' รายการ)' : ''}}:")(controller));
